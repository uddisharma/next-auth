            ...
            <div className="container px-4 text-center max-w-lg">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex gap-2 justify-center">
                        ...
                        />
                        <Button disabled={isSubmitting} type="submit" className="bg-yellow text-btnblue hover:bg-yellow p-5">
                            {isSubmitting ? "Subscribing..." : "Subscribe"}
                        </Button>
                    </div>
                    {errors.email && <p className="mt-4 text-left text-red-500">{errors.email.message}</p>}
                </form>
            </div>
        </section>
    );
