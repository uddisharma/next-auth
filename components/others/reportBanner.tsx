                ...
                <Tabs defaultValue="general" className="w-full">
                    <div className="flex justify-center mb-6 md:mb-10">
                        <TabsList className="grid w-full max-w-md grid-cols-2 items-center justify-center rounded-[144px] bg-white border-btnblue border-[1px] h-[45px] text-btnblue font-bold">
                            <TabsTrigger value="general" className="data-[state=active]:bg-[#1B2B4B] data-[state=active]:text-white rounded-[144px] h-[35px] text-xs md:text-sm">
                                General Hair Health
                            </TabsTrigger>
                            <TabsTrigger value="analysis" className="data-[state=active]:bg-[#1B2B4B] data-[state=active]:text-white rounded-[144px] h-[35px] text-xs md:text-sm">
                                Hair Loss Analysis
                            </TabsTrigger>
                        </TabsList>
                    </div>
    ...
    return (
        <div className="flex flex-col md:flex-row ">
            ...
            <Card className="w-full md:w-1/4 p-5 mb-6 md:mb-0">
                <h2 className="text-xl font-semibold text-center mb-6">Your Hair Score</h2>
                <div className="relative w-48 h-48 mx-auto">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-3xl font-bold">75<span className="text-lg font-normal">/100</span></span>
                    </div>
                </div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 md:ml-4">
                <Card className="p-6 h-fit-content">
                    <h2 className="text-xl font-semibold text-left mb-6">Total Hair Count</h2>
                    <div className="flex items-center justify-center">
                        <span className="text-[48px] md:text-[64px] font-bold text-btnblue">95,675</span>
                    </div>
                </Card>
                ...
                <div className="space-y-6">
                    <div className="space-y-4">
                        <div className="text-[#1B2B4B]">
                            <p className="font-medium">Your Hair Count: <span className="font-bold">45 follicles/cm²</span></p>
                            <p className="font-medium">Average Hair Count (Peers): <span className="font-bold">60 follicles/cm²</span></p>
                            <p className="font-medium">Scalp Coverage: <span className="font-bold">80% (Moderate Coverage)</span></p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-gray-700">
                            <li>• Your hair density is below the average, indicating potential thinning.</li>
    ...
    return (
        <div className="relative h-20">
            <svg className="w-full h-full" viewBox="0 0 400 100">
                ...
                <text x="0" y="20" className="text-xs" fill="#666">145908</text>
                <text x="350" y="20" className="text-xs" fill="#666">91294</text>
            </svg>
