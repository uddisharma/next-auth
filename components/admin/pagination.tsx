...
export default function Pagination({ searchParams, totalBlogs, totalPages }: PageProps) {
    ...
    const renderPageButtons = () => {
        ...
        if (totalPages <= maxVisiblePages) {
            ...
            if (page > 3) {
                buttons.push(
                    <Button key="ellipsis1" variant="outline" size="icon" className="h-8 w-8 bg-white" disabled>
                        ...
                    </Button>
                );
            }
            ...
            if (page < totalPages - 2) {
                buttons.push(
                    <Button key="ellipsis2" variant="outline" size="icon" className="h-8 w-8 bg-white" disabled>
                        ...
                    </Button>
                );
            }
