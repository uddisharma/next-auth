...
const ReportBanner = () => {
    return (
        <div className="w-full max-w-6xl mx-auto p-4 md:p-6 space-y-6 mt-[-15px]">
            <Tabs  defaultValue="general" className="w-full max-w-md mx-auto mb-6 md:mb-10">
                <TabsList className="grid w-full grid-cols-2 items-center justify-center rounded-[144px] bg-white border-btnblue border-[1px] h-[45px] text-btnblue font-bold">
            ...
            <div className="flex flex-col md:flex-row p-4 bg-[#F2F2F2] rounded-xl">
