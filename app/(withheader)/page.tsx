...
//   return (
//     <div className="min-h-screen bg-yellow pt-20">
//       <div className='px-12'>
//         <h1 className="text-4xl md:text-5xl text-btnblue leading-tight">
//           Your Journey to{' '}
//           <span className=" font-semibold">Healthier Hair</span>
//         </h1>
//         <div className="grid grid-cols-12 gap-4">

//           <div className="col-span-5 p-4">
//             <h1 className="text-4xl md:text-5xl text-btnblue leading-tight mt-5">
//               <span className="flex items-center gap-2">
//                 Starts Here!
//                 <span className="inline-block w-8 h-8 bg-[#1a1a2e] rounded-sm" />
//               </span>
//             </h1>

//             <p className="text-lg text-[#1a1a2e]/80">
//               Get tailored hair care treatments based on advanced hair and scalp analysis.
//             </p>

//             <div className="flex flex-col sm:flex-row gap-4">
//               <button className="px-6 py-3 bg-[#1a1a2e] text-white rounded-md hover:bg-[#1a1a2e]/90 transition-colors">
//                 Get Your Hair Analysis
//               </button>
//               <button className="px-6 py-3 border-2 border-[#1a1a2e] text-[#1a1a2e] rounded-md hover:bg-[#1a1a2e]/10 transition-colors">
//                 Learn More
//               </button>
//             </div>
//           </div>
//           <div className="col-span-4">
//             <div className="relative aspect-[3/4] w-full max-w-xl mx-auto">
//               <Image
//                 src="/men.png"
//                 alt="Hair care demonstration"
//                 fill
