            ...
            <main className="container mx-auto py-8">
                ...
                <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button variant="outline" className="w-[200px] md:w-[280px] justify-start text-left font-normal">
                                    <Calendar className="mr-2 h-4 w-4" />
                                    {date ? format(date, 'PPP') : <span>Pick a date</span>}
                                </Button>
                            </PopoverTrigger>
                ...
                <div className="flex flex-wrap gap-4 mb-6">
                    <div className="flex items-center gap-4">
                        <Input
                            type="search"
                            placeholder="Search items..."
                            className="w-full md:w-[240px] bg-btnblue text-white placeholder:text-white"
                        />
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        <Button variant="outline" className="border-black border-[1px]">
                            Export
                        </Button>
